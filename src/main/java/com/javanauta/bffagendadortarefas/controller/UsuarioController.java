...
public class UsuarioController {
    ...
    @GetMapping
    @Operation(summary = "Buscar dados de Usuários por Emaill",description = "Buscar dados do usuário")
    ...
    @PutMapping("/endereco")
    @Operation(summary = "Atualizar Endereçs de Usuários",description = "Atualizar endereço de usuário")
    @ApiResponse(responseCode = "200", description = "Endereço atualizado com sucesso")
    @ApiResponse(responseCode = "403", description = "Usuário não cadastradoo")
    @ApiResponse(responseCode = "500", description = "Erro de servidor")
    @ApiResponse(responseCode = "401", description = "Credenciais inválidas")
